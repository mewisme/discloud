...
const renderRouterLink: AppLinkRenderer = ({
  href,
  children,
  onNavigate,
}) => (
    ...
    <AppShellFrame
      sidebar={
        <AppSidebarView
          ...
          header={
            <WorkspaceIdentity username={workspaceUsername} />
          }
    ...
    <DropdownMenu>
      ...
      <DropdownMenuContent align="end" className="w-64">
        ...
        <DropdownMenuItem
          disabled={busy}
          onClick={() =>
            void perform(changeServer, "/connect")
          }
        >
          <ServerIcon />
          Change server
        ...
        {error ? (
          <>
            <DropdownMenuSeparator />
            <DropdownMenuLabel className="whitespace-normal text-xs font-normal text-destructive">
              {error}
            </DropdownMenuLabel>
          </>
        ) : null}
