...
import { useUploadDockState } from "../core/upload-store"
import { uploadTaskPercent } from "../core/upload-task"

const completionHideDelayMs = 3000

export function DesktopUploadDock({ username }: { username: string }) {
