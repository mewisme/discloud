  ...
  return (
    <div className="mx-auto flex w-full max-w-7xl flex-col gap-5">
      <div>
        ...
        <p className="text-sm text-muted-foreground">Search files and folders in @{workspace.username}&apos;s workspace.</p>
      </div>
      ...
      <SearchResults key={`search-results:${workspace.id}:${queryKey}`} options={options} admin={admin} />
    </div>
  )
}
