...
export function BotRuntimeSummary({
  ...
  const draining = countState(snapshot, "draining")
  const disabled = countState(snapshot, "disabled")
  const unhealthy = countState(snapshot, "unhealthy")
