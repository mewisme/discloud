...
export function FileBreadcrumbs({ items, onNavigate }: { items: readonly FileBreadcrumbItem[]; onNavigate?: (item: FileBreadcrumbItem) => void }) {
...
function BreadcrumbEntry({ item, current, onNavigate }: { item: FileBreadcrumbItem; current: boolean; onNavigate?: (item: FileBreadcrumbItem) => void }) {
...
function BreadcrumbMenuEntry({ item, onNavigate }: { item: FileBreadcrumbItem; onNavigate?: (item: FileBreadcrumbItem) => void }) {
